...
export default function BillTemplateSettingsPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8">
      <PageHelpDropdown steps={["Selectează unul dintre cele trei șabloane disponibile.", "Verifică aspectul în zona de previzualizare.", "Apasă „Salvează alegerea” pentru a-l folosi la facturile următoare."]} note="Previzualizarea folosește date demonstrative; documentele tipărite vor avea datele reale." />
