...
export default function ShippingPage() {
  const defaultData: ShippingData = {
    ...
    title: "Safe Shipping",
    description: [
      "At Repair Service, we specialise in providing comprehensive transportation and shipping services for a wide range of vehicles, encompassing all makes, models and years of manufacture. Our highly experienced team is dedicated to ensuring the safe and careful transportation of your vehicle from one location to another.",
      ...
      "From our enclosed shipping trailers that protect your car from the elements to our open trailer options which allow for direct loading and unloading, Repair Service has you covered when it comes to car transport.",
